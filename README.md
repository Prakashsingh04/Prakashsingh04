...
![LangChain-style RAG](https://img.shields.io/badge/-RAG%20%2F%20Agentic%20AI-6E56CF?style=flat-square)
...
|---|---|---|
| **[Visual Product Matcher](https://github.com/Prakashsingh04/Visualise-Product-Matcher-JINA-AI)** | Upload an image or URL to find visually similar products via CLIP embeddings + cosine similarity. [Live demo](https://visualise-appuct-matcher-jina-ai-6yvussbfby48ctg9bdchz7.streamlit.app/) | FastAPI, Streamlit, MongoDB Atlas, Jina CLIP v2 |
| **[PDF-DOST](https://github.com/Prakashsingh04/PDF-DOST)** | Chat with any PDF in natural language with a real-time document preview (RAG pipeline). [Live demo](https://pdf-dost-gilt.vercel.app) | React, Tailwind, Flask, RAG |
| **[Mobile Phone Addiction Detection](https://github.com/Prakashsingh04/Mobile-Phone-Addiction)** | Predicts teen phone-addiction levels via regression & classification (~91% accuracy). | Python, scikit-learn, Random Forest |
...
<p align="center">
  <a href="https://prakashsingh.me/">Portfolio</a> ·
  <a href="https://linkedin.com/in/prakashsingh04">LinkedIn</a> ·
  <a href="mailto:imprakash.work04@gmail.com">Email</a>
</p>
